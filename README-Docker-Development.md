...
This guide provides step-by-step instructions for setting up a local development environment using Docker to integrate with your remote n8n server running on `molaflow.com`.
...
services:
  frontend:
    ...
    environment:
      ...
      - NEXT_PUBLIC_N8N_URL=https://molaflow.com
  ...
  backend:
    ...
    environment:
      ...
      - N8N_SERVER_URL=https://molaflow.com
      - N8N_API_URL=https://molaflow.com/api
      - JWT_SECRET=your-local-development-jwt-secret-here
      - CORS_ORIGINS=http://localhost:3000,https://molaflow.com
    depends_on:
      - db
      - redis
...
N8N_SERVER_URL=https://molaflow.com
N8N_API_URL=https://molaflow.com/api
N8N_WEBHOOK_URL=https://molaflow.com/webhook
...
# CORS Configuration
CORS_ORIGINS=http://localhost:3000,http://localhost:80,https://molaflow.com
...
app.add_middleware(
    ...
    allowed_hosts=["localhost", "127.0.0.1", "molaflow.com", "*"]  # * for development
)
...
class Settings(BaseSettings):
    ...
    # n8n Configuration
    N8N_SERVER_URL: str = "https://molaflow.com"
    N8N_API_URL: str = "https://molaflow.com/api"
    N8N_API_KEY: str = ""
    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "frame-ancestors 'self' https://molaflow.com;",
          },
        ],
      },
    ];
...
curl -I https://molaflow.com/user/1
```
...
docker-compose -f docker-compose.dev.yml exec backend curl https://molaflow.com/health
```
