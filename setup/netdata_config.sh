...
[global]
    ...
    # Set directories
    cache directory = ${NETDATA_CACHE_DIR:-/var/cache/netdata}
    lib directory = ${NETDATA_LIB_DIR:-/var/lib/netdata}
    log directory = ${NETDATA_LOG_DIR:-/var/log/netdata}
    run directory = ${NETDATA_RUN_DIR:-/var/run/netdata}
    web files directory = ${NETDATA_WEB_DIR:-/usr/share/netdata/web}
